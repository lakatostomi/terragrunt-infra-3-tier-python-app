...
locals {
  ...
  frontend_test_sa = local.module_inputs.frontend_test_sa
  backend_test_sa  = local.module_inputs.backend_test_sa
}
...
inputs = {
  ...
  firewall_rules = {
    allow-http-between-tiers = {
      ...
      source_service_accounts = [local.frontend_test_sa]
      target_service_accounts = [local.backend_test_sa]
    }
  }

  # subnet_iam = {
  #   "${local.region}/${local.app_subnet}" = [
  #     local.frontend_test_sa,
  #     local.backend_test_sa
  #     ]
  # }
